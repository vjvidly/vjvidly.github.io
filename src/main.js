        ...
        <div class="track-title">
          ...
          ${track.url ? `
            <a href="${track.url}" target="_blank" class="sc-badge" title="Open in SoundCloud" onclick="event.stopPropagation()">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M18.81 7.11c-.38 0-.76.03-1.13.09C17.06 6.08 15.99 5 14.7 5c-1.21 0-2.26.93-2.45 2.11C11.63 7.04 11 7 10.35 7a4.35 4.35 0 0 0-4.35 4.35v1.28c0 .24.19.43.43.43h.11c.24 0 .43-.19.43-.43v-1.28c0-1.92 1.56-3.48 3.48-3.48.1 0 .21.01.31.02.24.02.44-.15.46-.39.04-.33.19-.65.42-.9.25-.28.61-.45.99-.45s.74.17.99.45c.23.25.38.57.42.9.02.24.22.41.46.39.1-.01.21-.02.31-.02 1.92 0 3.48 1.56 3.48 3.48 0 .1-.01.2-.02.3-.02.24.15.45.39.47.1.01.2.02.3.02 1.92 0 3.48 1.56 3.48 3.48s-1.56 3.48-3.48 3.48h-1.39c-.24 0-.43.19-.43.43s.19.43.43.43h1.39c2.39 0 4.35-1.95 4.35-4.35s-1.95-4.35-4.35-4.35zM.44 14.15v2.85c0 .24.19.43.43.43s.43-.19.43-.43v-2.85c0-.24-.19-.43-.43-.43s-.43.19-.43.43zm1.61-2.14v5.04c0 .24.19.43.43.43s.43-.19.43-.43V12.01c0-.24-.19-.43-.43-.43s-.43.19-.43.43zm1.61-.83v5.87c0 .24.19.43.43.43s.43-.19.43-.43V11.18c0-.24-.19-.43-.43-.43s-.43.19-.43.43zm1.61-1.07v6.94c0 .24.2.44.44.44s.44-.2.44-.44V10.11c0-.24-.2-.44-.44-.44s-.44.2-.44.44zm1.61.12v6.82c0 .24.2.44.44.44s.44-.2.44-.44V10.23c0-.24-.2-.44-.44-.44s-.44.2-.44.44zm1.61-1.07v7.89c0 .24.2.44.44.44s.44-.2.44-.44V9.16c0-.24-.2-.44-.44-.44s-.44.2-.44.44z"/></svg>
            </a>
          ` : ''}
        </div>
