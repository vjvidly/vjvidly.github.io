        ...
        <div class="track-title">
          ...
          ${track.url ? `
            <a href="${track.url}" target="_blank" class="sc-badge" title="Open in SoundCloud" onclick="event.stopPropagation()">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M11.56,9.35c.18,0,.32,.14,.32,.32v7s-.14,.32-.32,.32-.32-.14-.32-.32v-7c0-.18,.14-.32,.32-.32Zm-1.85,2c.18,0,.32,.14,.32,.32v5s-.14,.32-.32,.32-.32-.14-.32-.32v-5c0-.18,.14-.32,.32-.32Zm-1.85,1.33c.18,0,.32,.14,.32,.32v3.67s-.14,.32-.32,.32-.32-.14-.32-.32v-3.67c0-.18,.14-.32,.32-.32Zm-1.85,1c.18,0,.32,.14,.32,.32v2s-.14,.32-.32,.32-.32-.14-.32-.32v-2c0-.18,.14-.32,.32-.32Zm13.19-2.34c.18,0,.32,.14,.32,.33v5.67s-.14,.33-.32,.33h-.01s-.32-.14-.32-.33V9.35c0-.18,.14-.33,.32-.33h.01Zm-1.85,1.33c.18,0,.32,.14,.32,.32v4.34s-.14,.33-.32,.33h-.01s-.32-.14-.32-.33v-4.34c0-.18,.14-.32,.32-.32h.01Zm10.15,2c0,2.16-1.75,3.91-3.91,3.91s-3.91-1.75-3.91-3.91,.01-.24,.01-.24,.09-.28,.24-.31c.08-.01,.17-.02,.25-.02,2.14,0,3.88-1.74,3.88-3.88,0-1.89-1.35-3.46-3.13-3.8-1.3-.25-2.69,.26-3.53,1.3-.06,.07-.16,.11-.25,.1-.08,0-.23,0-.3,0-2.16,0-3.91,1.75-3.91,3.91,0,.08,0,.16,.01,.24,.02,.15,.09,.28,.24,.31,2.02,.33,3.51,2.05,3.51,4.1Z"/></svg>
            </a>
          ` : ''}
        </div>
