        ...
        <div class="track-title">
          ...
          ${track.url ? `
            <a href="${track.url}" target="_blank" class="sc-badge" title="Open in SoundCloud" onclick="event.stopPropagation()">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M7.4 16.5h-.1c-.4 0-.8-.3-.8-.8v-3c0-.4.3-.8.8-.8h.1c.4 0 .7.3.7.8v3c0 .5-.3.8-.7.8zm3.2 0h-.1c-.4 0-.7-.3-.7-.8V9.8c0-.4.3-.8.7-.8h.1c.4 0 .8.3.8.8v5.9c0 .5-.4.8-.8.8zm-1.6 0h-.1c-.4 0-.7-.3-.7-.8v-5c0-.4.3-.8.7-.8h.1c.4 0 .7.3.7.8v5c0 .5-.3.8-.7.8zm-3.2 0h-.1c-.4 0-.8-.3-.8-.8v-1.6c0-.4.3-.8.8-.8h.1c.4 0 .7.3.7.8v1.6c0 .5-.3.8-.7.8zm-1.6 0h-.1c-.4 0-.7-.3-.7-.8v-.7c0-.4.3-.8.7-.8h.1c.4 0 .8.3.8.8v.7c0 .5-.4.8-.8.8zm-1.6 0h-.1c-.4 0-.7-.3-.7-.8v-.3c0-.4.3-.8.7-.8h.1c.4 0 .8.4.8.8v.4c0 .4-.4.7-.8.7zm9.6 0h-.1a.8.8 0 01-.7-.8V8.1c0-.4.3-.8.7-.8h.1c.4 0 .8.4.8.8v7.6c0 .4-.4.8-.8.8zm1.6 0h-.1c-.4 0-.7-.3-.7-.8V8.9c0-.4.3-.8.7-.8h.1c.4 0 .7.3.7.8v6.8c0 .5-.3.8-.7.8zm8.8-3c0 2.5-2 4.5-4.5 4.5h-2.7V10c1.4-1.9 3.6-3 6-3 1.1 0 2.1.2 3 .7.1.1.2.3.1.5l-.2.1c-.8-.5-1.8-.8-2.9-.8-3.3 0-6 2.7-6 6 0 .1 0 .2.1.2.1.1.2.1.4.1.1 0 .2.1.2.2v5.7h2.1c2.2 0 4-1.8 4-4s-1.8-4-4-4c-.1 0-.2 0-.3.1l-.3-.6c1.1-.3 2.1-.5 3.1-.5 2.5 0 4.5 2 4.5 4.5z"/></svg>
            </a>
          ` : ''}
        </div>
