        ...
        <div class="track-title">
          ...
          ${track.url ? `
            <a href="${track.url}" target="_blank" class="sc-badge" title="Open in SoundCloud" onclick="event.stopPropagation()">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M11.56,8.35c.18,0,.32,.14,.32,.32v8s-.14,.32-.32,.32-.32-.14-.32-.32v-8c0-.18,.14-.32,.32-.32Zm-1.85,2c.18,0,.32,.14,.32,.32v6s-.14,.32-.32,.32-.32-.14-.32-.32v-6c0-.18,.14-.32,.32-.32Zm-1.85,1.33c.18,0,.32,.14,.32,.32v4.67s-.14,.32-.32,.32-.32-.14-.32-.32v-4.67c0-.18,.14-.32,.32-.32Zm-1.85,1c.18,0,.32,.14,.32,.32v3s-.14,.32-.32,.32-.32-.14-.32-.32v-3c0-.18,.14-.32,.32-.32Zm-1.85,.67c.18,0,.32,.14,.32,.32v1.67s-.14,.32-.32,.32-.32-.14-.32-.32v-1.67c0-.18,.14-.32,.32-.32Zm-1.85,.67c.18,0,.32,.14,.32,.32v.33s-.14,.32-.32,.32-.32-.14-.32-.32v-.33c0-.18,.14-.32,.32-.32Zm13.19-6c.18,0,.32,.14,.32,.33v10.67s-.14,.33-.32,.33h-.01s-.32-.14-.32-.33V8.35c0-.18,.14-.33,.32-.33h.01Zm-1.85,1.33c.18,0,.32,.14,.32,.32v9.34s-.14,.33-.32,.33h-.01s-.32-.14-.32-.33v-9.34c0-.18,.14-.32,.32-.32h.01Zm-1.85,.67c.18,0,.32,.14,.32,.32v8s-.14,.33-.32,.33h-.01c-.18,0-.32-.14-.32-.33v-8c0-.18,.14-.32,.32-.32h.01Zm8.31,4c3.31,0,6,2.69,6,6s-2.69,6-6,6h-6.67V13.01c.33-4.42,3.91-8,8.35-8,2.01,0,3.84,.75,5.24,1.95s.16,.32,.04,.46c-.11,.14-.32,.16-.46,.04-1.29-1.12-2.98-1.78-4.82-1.78-4.07,0-7.38,3.3-7.38,7.37v5.27h5.7c2.94,0,5.33-2.39,5.33-5.33s-2.39-5.33-5.33-5.33c-.1,0-.19,0-.29,.02-.18.02-.34-.11-.36-.29s.11-.34,.29-.36c.12-.01,.24-.02,.36-.02Z"/></svg>
            </a>
          ` : ''}
        </div>
