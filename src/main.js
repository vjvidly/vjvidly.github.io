        ...
        <div class="track-title">
          ...
          ${track.url ? `
            <a href="${track.url}" target="_blank" class="sc-badge" title="Open in SoundCloud" onclick="event.stopPropagation()">
              <svg width="12" height="12" viewBox="0 0 100 100" fill="currentColor"><path d="M12.91 35.5a14.29 14.29 0 0 0-14.32 14.27V68.66c0 10.74 8.71 19.45 19.45 19.45H81.33c16.14 0 29.23-13.09 29.23-29.23s-13.09-29.23-29.23-29.23c-6.14 0-11.79 1.89-16.45 5.12a14.29 14.29 0 0 0-11.97-6.27zm-11.8 15.73V73c0 1.68 1.37 3.05 3.05 3.05s3.05-1.37 3.05-3.05V51.23c0-1.68-1.37-3.05-3.05-3.05s-3.05 1.37-3.05 3.05zm14.16-7.85V72.5c0 1.68 1.37 3.05 3.05 3.05s3.05-1.37 3.05-3.05V43.38c0-1.68-1.37-3.05-3.05-3.05s-3.05 1.37-3.05 3.05zm14.16-3.05V72.5c0 1.68 1.37 3.05 3.05 3.05s3.05-1.37 3.05-3.05V40.33c0-1.68-1.37-3.05-3.05-3.05s-3.05 1.37-3.05 3.05zm14.15-2.09V72.5c0 1.68 1.38 3.05 3.06 3.05s3.06-1.37 3.06-3.05V38.24c0-1.68-1.38-3.05-3.06-3.05s-3.06 1.37-3.06 3.05z"/></svg>
            </a>
          ` : ''}
        </div>
