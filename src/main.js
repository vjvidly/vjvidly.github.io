        ...
        <div class="track-title">
          ...
          ${track.url ? `
            <a href="${track.url}" target="_blank" class="sc-badge" title="Open in SoundCloud" onclick="event.stopPropagation()">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M11.56 8.35c.18 0 .33.15.33.32v8c0 .18-.15.33-.33.33s-.32-.15-.32-.33v-8c0-.17.15-.32.32-.32zm-1.85 2c.18 0 .33.15.33.32v6c0 .18-.15.33-.33.33s-.33-.15-.33-.33v-6c0-.17.15-.32.33-.32zm-1.85 1.33c.18 0 .33.15.33.32v4.67c0 .18-.15.33-.33.33s-.33-.15-.33-.33v-4.67c0-.17.15-.32.33-.32zm-1.85 1c.18 0 .33.15.33.32v3c0 .18-.15.33-.33.33s-.33-.15-.33-.33v-3c0-.17.15-.32.33-.32zm-1.85.67c.18 0 .33.15.33.32v1.67c0 .18-.15.33-.33.33s-.33-.15-.33-.33v-1.67c0-.17.15-.32.33-.32zm-1.85.67c.18 0 .33.15.33.32v.33c0 .18-.15.33-.33.33s-.33-.15-.33-.33v-.33c0-.17.15-.32.33-.32zm13.19-6c.18 0 .33.15.33.33v10.67c0 .18-.15.33-.33.33s-.33-.15-.33-.33V8.35c0-.18.15-.33.33-.33zm-1.85 1.33c.18 0 .33.15.33.33v9.34c0 .18-.15.33-.33.33s-.33-.15-.33-.33v-9.34c0-.18.15-.33.33-.33zm-1.85.67c.18 0 .33.15.33.33v8c0 .18-.15.33-.33.33s-.33-.15-.33-.33v-8c0-.18.15-.33.33-.33zm8.31 4c3.31 0 6 2.69 6 6s-2.69 6-6 6h-6.67V13c.33-4.42 3.91-8 8.35-8 2.01 0 3.84.74 5.24 1.95.14.12.16.32.04.46-.12.14-.32.16-.46.04-1.29-1.12-2.98-1.78-4.82-1.78-4.07 0-7.38 3.3-7.38 7.37v5.28h5.7c2.94 0 5.33-2.39 5.33-5.33s-2.39-5.33-5.33-5.33c-.1 0-.19.01-.29.02-.18.02-.34-.11-.36-.29-.02-.18.11-.34.29-.36.12-.01.24-.02.36-.02z"/></svg>
            </a>
          ` : ''}
        </div>
